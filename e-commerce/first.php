  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" name="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="additems.html">Add Item</a></li>
	...
	<!-- start: 1st Page - Home -->
<div class="question"><h2>Why Shop With Us...</h2><h4>Growing your career is an Evolutioin - not a Revolution!</h4></div>
	<div id="home">
				...
				<div class="sl-slider">
					...
					<div class="sl-slide bg-1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						<div class="sl-slide-inner">
							...
							<h2>AVAILABILITY</h2>
							<blockquote><p>God does not begin by asking our Ability,only our Availability, and if we prove our Dependability, he will increase our Capability.</p><cite>Neal A. Maxwell</cite></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide bg-2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
						<div class="sl-slide-inner">
							...
							<h2>CONVENIENCE</h2>
							<blockquote><p>Convenience is ment for human beings.If you can't get it right way then you the right to snatch it.</p><cite>Areeb Masood</cite></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide bg-3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							...
							<h2>QUALITY</h2>
							<blockquote><p>Quality control is vitally important to us. By handling everything but the manufacturing process, we are able to keep the cost reasonable, maintain our exclusive relationship with our Customers and assure their complete Satisfaction.</p><cite>Our Team &hearts;</cite></blockquote>
						</div>
					</div>
					...
					<div class="sl-slide bg-4" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							...
							<h2>SUPPORTIVE COSTS</h2>
							<blockquote><p>The price of Anything is the amount of life you exchange with it.The key is great value at the right price.</p><cite>Henry David Thoreau</cite></blockquote>
						</div>
					</div>

					<div class="sl-slide bg-5" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
						<div class="sl-slide-inner">
							<div class="deco" data-icon="U"></div>
							<h2>UNIQUENESS</h2>
							<blockquote><p>We are incompetition with no one. We run our own race. We have no desire to play the game of being better than anyone,in any way,shap or form. We just aim to improve to be better than we were before. That's Us!</p><cite>Yashi and Sampada</cite></blockquote>
						</div>
					</div>
				</div><!-- /sl-slider -->
